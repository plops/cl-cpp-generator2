...
-   bracket .. Square brackets. Example: (bracket 1 2 3) =>
...
-   example/ — many usage examples (start with gen01.lisp or read the README in examples)isp or read the README in examples)