...
auto DrawFourier = [](auto sampleRate, auto realtimeDisplay, auto windowSize, auto fftw, auto x, auto y1, auto y2,
                      auto zfifo, auto file, auto start, auto logScale, auto selectedSatellites) {
...
void DrawPlot(const MemoryMappedComplexShortFile &file, FFTWManager &fftw,
    ...
    try {
        ...
        auto out = DrawFourier(sampleRate, realtimeDisplay, windowSize, fftw, x, y1, y2, zfifo, file, start, logScale,
                               selectedSatellites);
...
int main(int argc, char **argv) {
    try {
        ...
        auto file = initFile("/mnt5/gps/out_pnr4_3_31_202308061610.subset");
