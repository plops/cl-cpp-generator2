...
void DrawPlot(MemoryMappedComplexShortFile &file, std::shared_ptr<SdrManager> sdr, FFTWManager &fftw,
...
int main(int argc, char **argv) {
    try {
        ...
        auto file = MemoryMappedComplexShortFile("/mnt5/capturedData_L1_rate10MHz_bw5MHz_iq_short.bin",
                                                 128 * 1024 * 1024, 0);
