...
more structs. this function helps to initialize those structs."
  ...
  (defparameter *code-file* (asdf:system-relative-pathname 'cl-cpp-generator2 "example/04_vulkan/source/run_02_base.c"))
  (defparameter *vertex-file* (asdf:system-relative-pathname 'cl-cpp-generator2 "example/04_vulkan/source/run_02_base.vert"))
  (defparameter *frag-file* (asdf:system-relative-pathname 'cl-cpp-generator2 "example/04_vulkan/source/run_02_base.frag"))
  (let* ((vertex-code
	  `(do0
	    "#version 450"
	 ...
	 (code
	  `(do0
	    ...
	    "/* gcc -std=c18 run_01_base.cpp  `pkg-config --static --libs glfw3` -lvulkan -o run_01_base -march=native -O0 -ftime-report */"
	    " "
	    ...
	    (do0
	     ...
	     (defun readFile (filename)
	       (declare (type "const char*" filename)
			(values "char*"))
	       (let ((file (open filename (logior O_RDONLY))))
		 (unless (file.is_open)
		   (throw ("std::runtime_error"
