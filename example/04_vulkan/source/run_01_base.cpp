...
/*
g++ -std=c++17 run_01_base.cpp  `pkg-config --static --libs glfw3` -lvulkan -o
run_01_base -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wctor-dtor-privacy
...
VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities,
  ...
  if (UINT32_MAX != capabilities.currentExtent.width) {
    ...
    auto actualExtent{VkExtent2D(static_cast<uint32_t>(width),
...
private:
  ...
  void createInstance() {
    ...
    glfwExtensions = glfwGetRequiredInstanceExtensions(&glfwExtensionCount);
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                ...
                << " create instance _instance=" << _instance << std::endl;
    }
  }
  ...
  createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
    ...
    VkDeviceMemory bufferMemory;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create buffer buffer=" << buffer << std::endl;
    }
    ...
    vkGetBufferMemoryRequirements(_device, buffer, &memReq);
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " allocate memory bufferMemory=" << bufferMemory
                << std::endl;
    }
  ...
  VkCommandBuffer beginSingleTimeCommands() {
    VkCommandBuffer commandBuffer;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " allocate command-buffer" << std::endl;
    }
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " begin command-buffer commandBuffer=" << commandBuffer
                << std::endl;
    }
  ...
  uint32_t findMemoryType(uint32_t typeFilter,
    ...
    for (decltype(0 + ps.memoryTypeCount + 1) i = 0; i < ps.memoryTypeCount;
         i += 1) {
      if (1 << i & typeFilter &&
          properties == (properties & ps.memoryTypes[i].propertyFlags)) {
        return i;
      }
    }
    ...
    for (auto &shape : shapes) {
      for (auto &index : shape.mesh.indices) {
        ...
        vertex.texCoord = {
            ...
            1.0F - (attrib.texcoords[(1 + 2 * index.texcoord_index)])};
  ...
  createImage(uint32_t width, uint32_t height, uint32_t mipLevels,
    ...
    VkDeviceMemory imageMemory;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create image image=" << image << std::endl;
    }
    VkMemoryRequirements memReq;
    vkGetImageMemoryRequirements(_device, image, &memReq);
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " allocate memory imageMemory=" << imageMemory << std::endl;
    }
  ...
  void createTextureSampler() {
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create sampler _textureSampler=" << _textureSampler
                << std::endl;
    }
  }
  ...
  void createDescriptorSets() {
    ...
    _descriptorSets.resize(n);
    {
      ...
      if (!(VK_SUCCESS ==
            vkAllocateDescriptorSets(_device, &info, _descriptorSets.data()))) {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " allocate descriptor-set" << std::endl;
    }
  ...
  void createDescriptorPool() {
        ...
        {uboPoolSize, samplerPoolSize}};
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create descriptor-pool _descriptorPool=" << _descriptorPool
                << std::endl;
    }
  }
  ...
  void createUniformBuffers() {
    ...
    for (decltype(0 + n + 1) i = 0; i < n; i += 1) {
      auto [buf,
            mem]{createBuffer(bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
                              VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT ||
                                  VK_MEMORY_PROPERTY_HOST_COHERENT_BIT)};
  ...
  void createDescriptorSetLayout() {
        ...
        {uboLayoutBinding, samplerLayoutBinding}};
    {
      ...
      if (!(VK_SUCCESS == vkCreateDescriptorSetLayout(_device, &info, nullptr,
  ...
  void createSyncObjects() {
    ...
    for (decltype(0 + _MAX_FRAMES_IN_FLIGHT + 1) i = 0;
         i < _MAX_FRAMES_IN_FLIGHT; i += 1) {
  ...
  void createCommandBuffers() {
    ...
    for (decltype(0 + _commandBuffers.size() + 1) i = 0;
         i < _commandBuffers.size(); i += 1) {
      {
        VkCommandBufferBeginInfo info{{}};
        info.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
        info.flags = 0;
  ...
  void createCommandPool() {
    auto queueFamilyIndices{findQueueFamilies(_physicalDevice, _surface)};
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create command-pool _commandPool=" << _commandPool
                << std::endl;
    }
  }
  ...
  void createFramebuffers() {
    ...
    for (decltype(0 + n + 1) i = 0; i < n; i += 1) {
          ...
          {_colorImageView, _depthImageView, _swapChainImageViews[i]})};
      {
        ...
        info.layers = 1;
        if (!(VK_SUCCESS == vkCreateFramebuffer(_device, &info, nullptr,
  ...
  void createRenderPass() {
        ...
        {colorAttachment, depthAttachment, colorAttachmentResolve})};
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create render-pass _renderPass=" << _renderPass
                << std::endl;
    }
  }
  ...
  void createGraphicsPipeline() {
    ...
    viewport.x = 0.F;
    viewport.y = 0.F;
    viewport.width = 1.0F * _swapChainExtent.width;
    viewport.height = 1.0F * _swapChainExtent.height;
    ...
    colorBlending.blendConstants[3] = 0.F;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create pipeline-layout _pipelineLayout=" << _pipelineLayout
                << std::endl;
    }
    {
      ...
      if (!(VK_SUCCESS == vkCreateGraphicsPipelines(_device, VK_NULL_HANDLE, 1,
                                                    &info, nullptr,
                                                    &_graphicsPipeline))) {
        throw std::runtime_error(
  ...
  VkShaderModule createShaderModule(const std::vector<char> &code) {
    VkShaderModule shaderModule;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create shader-module shaderModule=" << shaderModule
                << std::endl;
    }
    return shaderModule;
  }
  ...
  void createSwapChain() {
    ...
    }
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create swapchain _swapChain=" << _swapChain << std::endl;
    }
  ...
  VkImageView createImageView(VkImage image, VkFormat format,
    ...
    VkImageView imageView;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create image-view imageView=" << imageView << std::endl;
    }
    return imageView;
  }
  ...
  void createImageViews() {
    ...
    for (decltype(0 + _swapChainImages.size() + 1) i = 0;
         i < _swapChainImages.size(); i += 1) {
  ...
  void createLogicalDevice() {
    ...
    deviceFeatures.samplerAnisotropy = VK_TRUE;
    {
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " create device _physicalDevice=" << _physicalDevice
                << std::endl;
    }
  ...
  void createColorResources() {
    ...
    transitionImageLayout(_colorImage, colorFormat, VK_IMAGE_LAYOUT_UNDEFINED,
  ...
  void drawFrame() {
    ...
    presentInfo.pResults = nullptr;
    {
      ...
      if (VK_SUBOPTIMAL_KHR == result2 | VK_ERROR_OUT_OF_DATE_KHR == result2 |
          _framebufferResized) {
  ...
  void updateUniformBuffer(uint32_t currentImage) {
    ...
    float time{std::chrono::duration<float, std::chrono::seconds::period>(
                   ...
                   .count()};
    const auto zAxis{glm::vec3(0.F, 0.F, 1.0F)};
    const auto angularRate{glm::radians(9.0F)};
    auto rotationAngle{time * angularRate};
    UniformBufferObject ubo{{}};
    ubo.model = glm::rotate(glm::mat4(1.0F), rotationAngle, zAxis);
    ubo.view = glm::lookAt(glm::vec3(2.0F, 2.0F, 2.0F),
                           glm::vec3(0.F, 0.F, 0.F), zAxis);
    ubo.proj = glm::perspective(
        glm::radians(45.F),
        _swapChainExtent.width / (1.0F * _swapChainExtent.height), 0.10F, 10.F);
  ...
  void cleanupSwapChain() {
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " cleanup depth: " << " _depthImageView=" << _depthImageView
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " pipeline: " << " _graphicsPipeline=" << _graphicsPipeline
    ...
    for (auto &view : _swapChainImageViews) {
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " image-view: " << " view=" << view << std::endl;
      vkDestroyImageView(_device, view, nullptr);
    };
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " swapchain: " << " _swapChain=" << _swapChain << std::endl;
    ...
    for (decltype(0 + _swapChainImages.size() + 1) i = 0;
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " ubo: " << " (aref _uniformBuffers i)="
                << _uniformBuffers[i] << " (aref _uniformBuffersMemory i)="
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " descriptor-pool: " << " _descriptorPool=" << _descriptorPool
        << std::endl;
  ...
  void cleanup() {
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " tex: " << " _textureSampler=" << _textureSampler
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " buffers: " << " _vertexBuffer=" << _vertexBuffer
    ...
    for (decltype(0 + _MAX_FRAMES_IN_FLIGHT + 1) i = 0;
      ...
      std::cout << std::chrono::high_resolution_clock::now()
                       ...
                       .count()
                << " " << __FILE__ << ":" << __LINE__ << " " << __func__
                << " sync: " << " (aref _renderFinishedSemaphores i)="
                << _renderFinishedSemaphores[i]
    ...
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " cmd-pool: " << " _commandPool=" << _commandPool << std::endl;
    vkDestroyCommandPool(_device, _commandPool, nullptr);
    std::cout
        << std::chrono::high_resolution_clock::now().time_since_epoch().count()
        << " " << __FILE__ << ":" << __LINE__ << " " << __func__
        << " rest: " << " _device=" << _device << " _instance=" << _instance
