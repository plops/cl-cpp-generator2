...
UsbDeviceDescriptor::UsbDeviceDescriptor(
    uint8_t b_length_, uint8_t b_device_class_, uint8_t b_device_sub_class_,
    uint8_t b_device_protocol_, uint16_t id_vendor_, uint16_t id_product_,
    uint16_t bcd_device_, uint8_t b_num_configurations_)
    : b_length{b_length_}, b_device_class{b_device_class_},
      b_device_sub_class{b_device_sub_class_},
...
uint8_t UsbDeviceDescriptor::GetBLength() const { return b_length; }
uint8_t UsbDeviceDescriptor::GetBDescriptorType() const {
  return b_descriptor_type;
}
uint16_t UsbDeviceDescriptor::GetBcdUsb() const { return bcd_usb; }
...
uint8_t UsbDeviceDescriptor::GetBMaxPacketSize() const {
...
uint8_t UsbDeviceDescriptor::GetIManufacturer() const { return i_manufacturer; }
uint8_t UsbDeviceDescriptor::GetIProduct() const { return i_product; }
uint8_t UsbDeviceDescriptor::GetISerialNumber() const {
