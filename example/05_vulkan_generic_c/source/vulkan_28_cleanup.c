...
void cleanupSwapChain (){
...
}
    {
        ...
        printf(" (dot state _descriptorPool)=");
...
void cleanup (){
            cleanupSwapChain();
    {
        ...
        printf(" (dot state _descriptorSetLayout)=");
    ...
    for (int i = 0;i<_MAX_FRAMES_IN_FLIGHT;(i)+=(1)) {
            ...
            printf(printf_dec_format(__func__), __func__);
            printf(" sync: ");
            printf(" (aref (dot state _renderFinishedSemaphores) i)=");
            ...
            printf(" (aref (dot state _imageAvailableSemaphores) i)=");
            ...
            printf(" (aref (dot state _inFlightFences) i)=");
