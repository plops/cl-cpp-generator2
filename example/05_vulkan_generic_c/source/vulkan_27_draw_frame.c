...
void updateUniformBuffer (uint32_t currentImage){
    ...
    glm_rotate_z(identity, rotationAngle, model);
    {
        ...
        printf(printf_dec_format(rotationAngle), rotationAngle);
        printf(" (%s)", type_string(rotationAngle));
        printf(" time=");
...
void drawFrame (){
        ...
        printf(" state._inFlightFences[state._currentFrame]=");
        ...
        printf(" ");
        printf(printf_dec_format(__func__), __func__);
        printf(" acquire next image: ");
        printf(" state._swapChain=");
        printf(printf_dec_format(state._swapChain), state._swapChain);
        printf(" (%s)", type_string(state._swapChain));
        printf(" state._imageAvailableSemaphores[state._currentFrame]=");
        printf(printf_dec_format(state._imageAvailableSemaphores[state._currentFrame]), state._imageAvailableSemaphores[state._currentFrame]);
        printf(" (%s)", type_string(state._imageAvailableSemaphores[state._currentFrame]));
        printf("\n");
};
