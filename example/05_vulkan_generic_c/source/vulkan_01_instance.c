...
void createInstance (){
...
};
    {
        ...
        printf(" glfwExtensionCount=");
        printf(printf_dec_format(glfwExtensionCount), glfwExtensionCount);
        printf(" (%s)", type_string(glfwExtensionCount));
        printf("\n");
};
    for (int i = 0;i<length(state._validationLayers);(i)+=(1)) {
                {
                                    __auto_type current_time  = now();
            printf("%6.6f", ((current_time)-(state._start_time)));
            printf(" ");
            ...
            printf(" state._validationLayers[i]=");
            printf(printf_dec_format(state._validationLayers[i]), state._validationLayers[i]);
            printf(" (%s)", type_string(state._validationLayers[i]));
            printf("\n");
};
}
    for (int i = 0;i<glfwExtensionCount;(i)+=(1)) {
            ...
            printf(printf_dec_format(i), i);
            printf(" (%s)", type_string(i));
            printf(" glfwExtensions[i]=");
            printf(printf_dec_format(glfwExtensions[i]), glfwExtensions[i]);
            printf(" (%s)", type_string(glfwExtensions[i]));
            printf("\n");
};
};
};