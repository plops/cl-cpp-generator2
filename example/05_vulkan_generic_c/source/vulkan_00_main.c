...
#include "proto2.h"
 ;
State state  = {._window=NULL, ._validationLayers={"VK_LAYER_KHRONOS_validation", "VK_LAYER_LUNARG_api_dump"}, ._physicalDevice=VK_NULL_HANDLE, ._deviceExtensions={VK_KHR_SWAPCHAIN_EXTENSION_NAME}};
void mainLoop (){
        {
