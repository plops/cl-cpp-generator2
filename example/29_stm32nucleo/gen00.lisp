...
(progn
  ...
  (let* ((n-channels 60 ;(* 16 1024)
	...
	(n-tx-chars (* 4 128))
	(n-dac-vals n-channels ; (- (floor n-channels 2) 0)
	  )
	  ...
	  `(main.c 2
		   (do0
		    ...
		    #+dac1 (do0
			    ...
			    (setf (aref value_dac 2) 0)
			    (setf (aref value_dac 3) 4095)
			    (setf (aref value_dac 4) 0)
			    (setf (aref value_dac 5) 0)
			    (setf (aref value_dac 6) 0)
			    (setf (aref value_dac 7) 4095)
