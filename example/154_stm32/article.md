...
i want to understand how to implement equivalent-time sampling using the HRTIM and ADC.
...
[10] adc_oversampling_en.DM00722433.pdf
...
- increase SNR with less CPU interaction
- thermal noise generated by diode or resistor to make the signal
  toggle randomly by 1/2 LSB
- provides .5 bit additional resolution for each doubling of
  oversampling rate

- triangular dither
- signal must not correlate with triangular dither signal
