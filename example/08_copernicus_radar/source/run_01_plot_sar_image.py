...
plt.plot(np.unwrap(np.angle(txh_iso_cal_0[count,:])), label="angle <txh_iso_cal_0>")
plt.grid()
plt.legend()
plt.figure()
...
plt.plot(np.unwrap(np.angle(txh_iso_cal_1[count,:])), label="angle <txh_iso_cal_1>")
plt.grid()
plt.legend()
plt.figure()
...
plt.plot(np.abs(txh_iso_cal_0[count,:]), label="|<txh_iso_cal_0>|")
plt.grid()
plt.legend()
plt.figure()
...
plt.plot(np.abs(txh_iso_cal_1[count,:]), label="|<txh_iso_cal_1>|")
plt.grid()
plt.legend()