...
plt.figure()
plt.plot(np.abs(np.mean(tx_cal_0, axis=0)))
plt.plot(np.abs(np.mean(tx_cal_1, axis=0)))
plt.plot(np.abs(np.mean(rx_cal_0, axis=0)))
plt.plot(np.abs(np.mean(rx_cal_1, axis=0)))
plt.plot(np.abs(np.mean(epdn_cal_0, axis=0)))
plt.plot(np.abs(np.mean(epdn_cal_1, axis=0)))
plt.plot(np.abs(np.mean(ta_cal_0, axis=0)))
plt.plot(np.abs(np.mean(ta_cal_1, axis=0)))
plt.plot(np.abs(np.mean(apdn_cal_0, axis=0)))
plt.plot(np.abs(np.mean(apdn_cal_1, axis=0)))
plt.plot(np.abs(np.mean(txh_iso_cal_0, axis=0)))
plt.plot(np.abs(np.mean(txh_iso_cal_1, axis=0)))