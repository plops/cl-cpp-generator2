...
| 36_gtk4_test               |   90% | gtk4 will have a scene graph and can optimize rendering lots of list entries. i want something like the webkit inspector timeline but that is probably quite complicated. i feel gtk has no coherent documentation and it is not very stable |          |
